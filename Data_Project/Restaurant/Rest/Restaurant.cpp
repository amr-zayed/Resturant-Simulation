...
void Restaurant::AssigningCookToOrder(Order* ord, Cook* cook, string& temp)
{
	...
	if (cook->GetType() == TYPE_VIP)
	{
		...
		{
			ordnum = ord->GetID();
			temp = "V" + to_string(cooknum) + "(V" + to_string(ordnum) + ") ";
			totalservVIP++;
		}
		if (ord->GetType() == TYPE_NRM)
		{
			ordnum = ord->GetID();
			temp = "V" + to_string(cooknum) + "(N" + to_string(ordnum) + ") ";
			totalservNRM++;
		}
	}
	if (cook->GetType() == TYPE_NRM)
	{
		...
		{
			ordnum = ord->GetID();
			temp = "N" + to_string(cooknum) + "(V" + to_string(ordnum) + ") ";
			totalservVIP++;
		}
		if (ord->GetType() == TYPE_NRM)
		{
			ordnum = ord->GetID();
			temp = "N" + to_string(cooknum) + "(N" + to_string(ordnum) + ") ";
			totalservNRM++;
	...
	if (cook->GetType() == TYPE_VGAN)
	{
		...
		{
			ordnum = ord->GetID();
			temp = "G" + to_string(cooknum) + "(V" + to_string(ordnum) + ") ";
			totalservVIP++;
		}
		if (ord->GetType() == TYPE_VGAN)
		{
			ordnum = ord->GetID();
			temp = "G" + to_string(cooknum) + "(G" + to_string(ordnum) + ") ";
			totalservVGAN++;
		}
	}
